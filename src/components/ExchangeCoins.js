...
export const ExchangeCoins = () => {
  ...
  return (
    <div className='px-4 py-4 font-body bg-white bg-opacity-10 backdrop-blur-md rounded-lg border border-yellow-600 shadow-lg items-center'>
      ...
      <div className='text-center mt-4 pb-4'>
        <button
          onClick={() => convert()}
          className='bg-brown background-opacity-10 backdrop-blur-md rounded-lg text-sm py-2 px-6 text-white font-semibold hover:bg-yellow-500 border border-white'
        >
          Exchange
        </button>
      </div>
