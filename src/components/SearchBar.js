...
//searchbar to show the search results.
        ...
        <div className='flex flex-grow rounded-sm shadow-md'>
          <div className='flex flex-grow items-center text-white'>
            ...
            <input
              ...
              className='flex border border-yellow-600 shadow-lg focus:ring-1 bg-white bg-opacity-10 backdrop-blur-md
      ...
      <div className='flex'>
        <span className='flex shadow-md rounded-lg'>
          <select
            ...
            ref={currencyRef}
            className='border border-yellow-600 text-gray-100 outline-none font-body pr-3 pl-2 rounded-lg w-[90px] md:w-[90px] sm:w-[90px] cursor-pointer bg-white bg-opacity-10 backdrop-blur-md z-1'
          >
